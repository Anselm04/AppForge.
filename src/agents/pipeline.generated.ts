...
export async function runAgentPipeline(
  ...
  try {
    ...
    const plannerSystemPrompt = [
      ...
      "Required runtime entrypoints: " + selectedStackAdapter.entrypoints.join(", "),
      "Required environment/config files: " + (selectedStackAdapter.environmentFiles.join(", ") || "none"),
