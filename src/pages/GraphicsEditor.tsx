      ...
      {showExport && (
        ...
        >
          ...
          >
            ...
            <div className="mb-4 p-4 rounded-lg border border-[#1e293b] bg-[#0a0e1a] space-y-3">
              <p className="text-sm font-semibold text-[#e2e8f0]">
                Attach to project
              </p>
              <p className="text-xs text-[#64748b]">
                Saves this graphic to{" "}
                <code className="text-[#94a3b8]">public/assets/</code> in a
                completed project.
              </p>
              <div className="flex flex-wrap gap-2">
                <select
                  ...
                  className="flex-1 min-w-[180px] bg-[#080c18] border border-[#1e293b] rounded-lg px-3 py-2 text-sm text-[#e2e8f0]"
                >
                ...
                <input
                  ...
                  className="w-40 bg-[#080c18] border border-[#1e293b] rounded-lg px-3 py-2 text-sm text-[#e2e8f0]"
                />
                <button
                  type="button"
                  disabled={
                    !attachProjectId ||
                    !attachFilename.trim() ||
                    attachToProject.isPending
                  }
                  onClick={attachSvgToProject}
                  className="px-4 py-2 rounded-lg bg-[#14b8a6] text-[#080c18] text-sm font-semibold hover:bg-[#0d9488] disabled:opacity-40 transition-colors"
                >
                  {attachToProject.isPending
                    ? "Attaching…"
                    : "Attach to project"}
              ...
              {attachStatus && (
                <p className="text-xs text-[#94a3b8]">{attachStatus}</p>
              )}
            </div>
