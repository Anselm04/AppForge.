...
export const APPFORGE_INTEGRATIONS: AppForgeIntegrationDefinition[] = [
  ...
  { id: "sprites-fly", name: "Sprites / Fly.io", kind: "external", job: "Isolated agent execution plus production application and worker runtime.", requiredForProduction: true, capabilities: ["agent-runtime", "workers", "deployments", "sandboxes"], env: ["FLY_APP_NAME", "SPRITES_HEALTH_URL", "SPRITES_API_TOKEN"] },
