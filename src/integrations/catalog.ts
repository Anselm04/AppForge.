...
export const APPFORGE_INTEGRATIONS: AppForgeIntegrationDefinition[] = [
  { id: "bubblav", name: "BubblaV AI Chatbot", kind: "external", job: "Customer support, onboarding, FAQs, troubleshooting, and human escalation.", requiredForProduction: false, capabilities: ["support", "onboarding", "faq", "escalation"], env: ["BUBBLAV_API_KEY", "BUBBLAV_CHAT_URL", "BUBBLAV_HEALTH_URL"] },
  ...
  { id: "sprites-fly", name: "Sprites / Fly.io", kind: "external", job: "Isolated agent execution plus production application and worker runtime.", requiredForProduction: true, capabilities: ["agent-runtime", "workers", "deployments", "sandboxes"], env: ["FLY_APP_NAME", "SPRITES_HEALTH_URL", "SPRITES_EXEC_URL", "SPRITES_API_TOKEN"] },
  ...
  { id: "openai-platform", name: "OpenAI Platform", kind: "external", job: "Model, agent, reasoning, and tool execution runtime for AppForge AI capabilities.", requiredForProduction: false, capabilities: ["models", "agents", "reasoning", "tool-use"], env: ["OPENAI_API_KEY"] },
  ...
  { id: "posthog", name: "PostHog", kind: "external", job: "Product analytics, funnels, retention, experiments, and feature flags.", requiredForProduction: false, capabilities: ["analytics", "funnels", "experiments", "feature-flags"], env: ["POSTHOG_HOST", "POSTHOG_KEY", "VITE_POSTHOG_KEY", "POSTHOG_PERSONAL_API_KEY", "POSTHOG_PROJECT_ID"] },
  ...
  { id: "twilio", name: "Twilio", kind: "external", job: "SMS, phone, voice, OTP verification, owner God Code verification, recovery, and optional 2FA communications.", requiredForProduction: false, capabilities: ["sms", "voice", "communications", "verify", "otp", "2fa"], env: ["TWILIO_ACCOUNT_SID", "TWILIO_AUTH_TOKEN", "TWILIO_VERIFY_SERVICE_SID"] },
  ...
  { id: "codex-security", name: "Codex Security", kind: "external", job: "Specialized AI-assisted source security review before production deployment.", requiredForProduction: false, capabilities: ["code-security", "review", "vulnerability-analysis"], env: ["CODEX_SECURITY_HEALTH_URL", "CODEX_SECURITY_EXEC_URL", "CODEX_SECURITY_TOKEN"] },
