...
export const STACK_RESEARCH_TARGETS: Record<string, StackResearchTarget> = {
  "react-node": {
    ...
    docs: [
      doc("https://react.dev/reference/react", "React reference"),
      doc("https://vite.dev/guide/", "Vite guide"),
    ],
  },
  "static-html": {
  ...
  "flutter-firebase": {
    ...
    packages: [
      { ecosystem: "Pub", name: "firebase_core" },
      { ecosystem: "Pub", name: "cloud_firestore" },
    ],
    repositories: ["flutter/flutter", "firebase/flutterfire"],
    docs: [
      doc("https://docs.flutter.dev/", "Flutter documentation"),
      doc(
  ...
  "electron-react": {
    ...
    docs: [
      doc("https://www.electronjs.org/docs/latest/", "Electron documentation"),
      doc(
  ...
  "tauri-rust": {
    ...
    packages: [
      { ecosystem: "crates.io", name: "tauri" },
      npm("@tauri-apps/cli"),
    ],
    repositories: ["tauri-apps/tauri"],
    docs: [
      doc("https://v2.tauri.app/", "Tauri 2 documentation"),
      doc("https://v2.tauri.app/security/", "Tauri security", "security"),
    ],
  },
  "api-service": {
  ...
  "node-service": {
    ...
    docs: [
      ...
      doc("https://nodejs.org/api/", "Node.js API"),
    ],
  },
  "python-service": {
    ...
    docs: [
      doc("https://fastapi.tiangolo.com/", "FastAPI documentation"),
      doc("https://devguide.python.org/versions/", "Python supported versions"),
    ],
  },
  "ai-agent-node": {
  ...
  "browser-automation": {
    ...
    docs: [
      doc("https://playwright.dev/docs/intro", "Playwright documentation"),
      doc(
...
export const DEPLOYMENT_TARGET_DOCS: Record<string, OfficialDocTarget[]> = {
  fly: [
    ...
    doc(
      ...
      "Fly.io pricing and resource limits",
      "platform_limits",
    ),
  ],
  vercel: [
    doc("https://vercel.com/docs/limits", "Vercel limits", "platform_limits"),
  ],
  netlify: [
...
export const INTEGRATION_TARGETS: IntegrationTarget[] = [
  {
    ...
    packages: [npm("stripe")],
    docs: [
      doc("https://docs.stripe.com/api", "Stripe API reference", "integration"),
      doc("https://docs.stripe.com/webhooks", "Stripe webhooks", "security"),
    ],
  },
  {
    match: /slack/i,
    name: "Slack",
    packages: [npm("@slack/web-api")],
    docs: [
      doc(
  ...
  },
  {
    ...
    docs: [
      doc("https://supabase.com/docs", "Supabase documentation", "integration"),
    ],
  },
  {
    match: /firebase/i,
    name: "Firebase",
    packages: [npm("firebase")],
    docs: [
      doc(
  ...
  },
  {
    ...
    packages: [npm("twilio")],
    docs: [
      doc("https://www.twilio.com/docs", "Twilio documentation", "integration"),
    ],
  },
  {
    match: /github/i,
    name: "GitHub",
    packages: [npm("@octokit/rest")],
    docs: [
      doc("https://docs.github.com/en/rest", "GitHub REST API", "integration"),
    ],
  },
  {
    match: /discord/i,
    name: "Discord",
    packages: [npm("discord.js")],
    docs: [
      doc(
  ...
  },
  {
    match: /shopify/i,
    name: "Shopify",
    packages: [npm("@shopify/shopify-api")],
    docs: [doc("https://shopify.dev/docs/api", "Shopify API", "integration")],
  },
  {
    match: /sendgrid/i,
    name: "SendGrid",
    packages: [npm("@sendgrid/mail")],
    docs: [
      doc(
  ...
  },
  {
    ...
    packages: [npm("resend")],
    docs: [
      doc("https://resend.com/docs", "Resend documentation", "integration"),
    ],
  },
];
...
export function integrationTarget(
  ...
  return (
    INTEGRATION_TARGETS.find((target) => target.match.test(integration)) ?? null
  );
}

export const SECURITY_DOCS: Record<
  "web" | "api" | "mobile" | "llm",
  OfficialDocTarget
> = {
...
export function securityDocForProduct(
  ...
  if (
    ...
    return SECURITY_DOCS.api;
  return SECURITY_DOCS.web;
}

export function monetizationDocsForProduct(
  productType: ProductType,
): OfficialDocTarget[] {
...
export const PRODUCT_TYPE_QUESTIONS: Record<
  ProductType,
...
> = {
  website: [
    {
      question:
        "What are the current Core Web Vitals and accessibility (WCAG) requirements?",
      query: "Core Web Vitals thresholds WCAG 2.2 accessibility requirements",
    },
  ],
  saas_application: [
    {
      question:
        "How should tenant isolation and server-side authorization be designed?",
      query:
        "multi-tenant SaaS tenant isolation server-side authorization best practices",
    },
  ],
  mobile_app: [
    {
      question: "What do current app store review policies require?",
      query:
        "App Store review guidelines Google Play policy requirements new apps",
    },
  ],
  desktop_app: [
    {
      question: "How are auto-update, code signing and distribution handled?",
      query: "desktop app auto update code signing notarization distribution",
    },
  ],
  game: [
    {
      question:
        "What are current browser game performance and input best practices?",
      query:
        "HTML5 browser game performance input handling mobile best practices",
    },
  ],
  ai_agent: [
    {
      question:
        "How should tool calling be constrained against prompt injection?",
      query:
        "LLM agent tool calling prompt injection defenses OWASP LLM top 10",
    },
  ],
  developer_tool: [
    {
      question: "How are developer tools packaged, versioned and distributed?",
      query:
        "developer CLI tool packaging semantic versioning distribution best practices",
    },
  ],
  api: [
    {
      question:
        "What are current API rate limiting, pagination and versioning practices?",
      query: "REST API rate limiting pagination versioning best practices",
    },
  ],
  ecommerce_product: [
    {
      question: "What are PCI DSS obligations for checkout and payments?",
      query: "PCI DSS hosted checkout requirements ecommerce payments",
    },
  ],
  browser_extension: [
    {
      question:
        "What do Chrome Web Store policies require for permissions and remote code?",
      query:
        "Chrome Web Store program policies Manifest V3 permissions remote code",
    },
  ],
  automation_tool: [
    {
      question:
        "What are the legal and technical limits of automating third-party sites?",
      query:
        "web automation scraping terms of service robots.txt rate limits legal",
    },
  ],
  data_product: [
    {
